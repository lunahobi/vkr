...
\usepackage{makecell} % переносы строк в заголовках таблиц
...
\renewcommand\labelenumii{\hspace{6.5mm}\theenumi.\theenumii.}
...
\captionsetup[table]{justification=raggedright,singlelinecheck=false,format=plain,margin=0pt,indention=0pt,aboveskip=0pt,belowskip=5pt}
