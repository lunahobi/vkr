...
\noindent{}Листинг Д.1 -- Фрагмент evaluate\_answer (backend/app/services/adaptive.py)
...
\noindent{}Листинг Д.2 -- Разрешённые теги и протоколы (backend/app/services/lesson\_player.py)
...
\noindent{}Листинг Д.3 -- Обработка учётной записи и токены (backend/app/services/auth.py)
...
\noindent{}Листинг Д.4 -- Старт попытки (backend/app/api/routes/tests.py)
...
\noindent{}Листинг Д.5 -- Роли пользователя и организация (backend/app/models/models.py)
...
\noindent{}Листинг Д.6 -- Компонент TestsPage (web/src/app-core.tsx, фрагмент)
...
\noindent{}Листинг Д.7 -- TestFlowScreen (mobile/lib/main.dart, фрагмент)
...
\noindent{}Листинг Д.8 -- Сервисы docker-compose.yml, фрагмент
